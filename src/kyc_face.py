...
def vgg_face(weights_path = 'E:/kyc-auth-master/src/vgg_face_weights.h5'):
...
epsilon_cos = 0.55 #cosine similarity (needs to be updated)
epsilon_dist = 120 #euclidean distance (needs to be updated)
